    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p><?= $row['user_name'] ?> <?= $row['user_secondName'] ?></p>
                <!-- Status -->
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li <?= ($page == 'profile') ? "class='active'" : "";  ?>><a href="profile.php"><i class="fa  fa-address-card-o"></i> <span>Профиль</span></a></li>
            <li <?= ($page == 'messages') ? "class='active'" : "";  ?> ><a href="messages.php?view=<?php echo $user; ?>"><i class="fa fa-envelope"></i>
                    <span>Сообщения</span>
                </a>
            </li>
