...
if (isset($_FILES['image']['name'])) {
    $saveto = "dist/img/image_users/$user.jpg";
    move_uploaded_file($_FILES['image']['tmp_name'], $saveto);
    $typeok = TRUE;

    if ($result->num_rows)
        queryMysql("UPDATE profiles SET user_image='$saveto' where user='$user'");
    else queryMysql("INSERT INTO profiles VALUES('$user', '$saveto')");
...
?>
    ...
    <div class="wrapper">
        ...
        -------------------------->
                ...
                <h2>Ваш профиль удачно обновлен. Перейдите в
